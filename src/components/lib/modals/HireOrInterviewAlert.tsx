...
import { IHireOrInterviewAlertProps } from '@/components/lib/modals/type';

const HireOrInterviewAlert: React.FC<IHireOrInterviewAlertProps> = ({
  isOpen,
  handleCloseModal,
  candidate,
  hireFn,
        ...
        <section>
          <div>
            ...
            <p className='my-6 text-center text-[16px] font-[400]'>
              {`You are about to ${status === 'Hired' ? 'Hire' : 'Interview'} ${
                candidate?.first
...
export default HireOrInterviewAlert;
